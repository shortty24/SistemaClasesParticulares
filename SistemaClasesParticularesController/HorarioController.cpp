...
void HorarioController::actualizarHorariosBD2(array<String^>^ listaHorarios) {
	AbrirConexion();
	SqlCommand^ objQuery = gcnew SqlCommand();
	objQuery->Connection = this->objConexion;
...
void HorarioController::actualizarHorariosBD(List<String^>^ listaHorarios) {
	AbrirConexion();
	SqlCommand^ objQuery = gcnew SqlCommand();
	objQuery->Connection = this->objConexion;
	...
	for each (String ^ lineaHorario in listaHorarios) {
		...
		objQuery->CommandText = "UPDATE HorariosProyecto SET DNIProfesor='"+dni+"',Dia='"+dia+
			"',ID0='"+horasxDia[0]+"',ID1='" + horasxDia[1] + "',ID2='" + horasxDia[2] + "',ID3='" + horasxDia[3] + "',ID4='" + horasxDia[4] +
			"',ID5='" + horasxDia[5] + "',ID6='" + horasxDia[6] + "',ID7='" + horasxDia[7] + "',ID8='" + horasxDia[8] + "',ID9='" + horasxDia[9] + "'," +
			"ID10 = '" + horasxDia[10] + "', ID11 = '" + horasxDia[11] + "', ID12 = '" + horasxDia[12] + "', ID13 = '" + horasxDia[13] + "', ID14 = '" + horasxDia[14] + 
			"',ID15 = '" + horasxDia[15] + "', ID16 = '" + horasxDia[16] + "', ID17 = '" + horasxDia[17] + "', ID18 = '" + horasxDia[18] + "', ID19 = '" + horasxDia[19] + "'," +
			"ID20 = '" + horasxDia[20] + "', ID21 = '" + horasxDia[21] + "', ID22 = '" + horasxDia[22] + "', ID23 = '" + horasxDia[23] + "';";
...
void HorarioController::insertarHorariosBD(String^ lineaTexto){
	...
	//array<String^>^ listaHorariosArray = gcnew array<String^>(25);

	String^ separadores = ";";
	//for (int i = 0; i < listaHorarios->Count; i++) {
		//listaHorariosArray = listaHorarios[i];
