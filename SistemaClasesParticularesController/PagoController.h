...
namespace SistemaClasesParticularesController {
	...
	public:
		...
		int buscarIncscripcionxcodigocompletaBD(String^ CodigoInscripcion);
		void aprobarPagoBD(String^ CodigoInscripcion);
		void desaprobarPagoBD(String^ CodigoInscripcion);
